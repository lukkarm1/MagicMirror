...
Module.register("newsfeed",{
    ...
    getDom: function() {
        ...
        wrapper.classList.add("newsfeedcontainer");
        ...
        if (this.newsItems.length > 0) {
            ...
            if (!this.config.showFullArticle && (this.config.showSourceTitle || this.config.showPublishDate)) {
                ...
                newscontent.appendChild(sourceAndTimestamp);
            }
            ...
            if (this.config.showQRCode && !this.config.showFullArticle) {
                if (this.newsItems[this.activeItem].url != "") {
                    var qrdiv = document.createElement("div");
                    qrdiv.classList.add("qrcode");

                    new QRCode(qrdiv, {
                        text: this.newsItems[this.activeItem].url,
                        width: 150,
                        height: 150,
                        colorDark: "#fff",
                        colorLight: "#000",
